...
var G__42146 = devtools.prefs.pref(v);
v = G__42146;
continue;
} else {
return v;
...
}catch (e42092){var _e__41248__auto__ = e42092;
return false;
}})();
...
}catch (e42100){var _e__41248__auto__ = e42100;
return false;
}})();
...
}catch (e42102){var _e__41248__auto__ = e42102;
return false;
}}
}
});
...
var vec__42107 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42107,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42107,(1),null);
...
return cljs.core.some((function (p1__42110_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__42110_SHARP_);
}),template);
});
