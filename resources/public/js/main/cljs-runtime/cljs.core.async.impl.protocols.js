...
var cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_51698 = (function (port,fn1_handler){
...
return cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_51698(port,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_51699 = (function (port,val,fn1_handler){
var x__5393__auto__ = (((port == null))?null:port);
...
return cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_51699(port,val,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_51700 = (function (chan){
...
return cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_51700(chan);
}
});

var cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_51701 = (function (chan){
var x__5393__auto__ = (((chan == null))?null:chan);
...
return cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_51701(chan);
}
});
...
var cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_51703 = (function (h){
...
return cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_51703(h);
}
});

var cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_51705 = (function (h){
var x__5393__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_51705(h);
}
});

var cljs$core$async$impl$protocols$Handler$commit$dyn_51706 = (function (h){
var x__5393__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$commit$dyn_51706(h);
}
});
...
var cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_51707 = (function (b){
...
return cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_51707(b);
}
});

var cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_51711 = (function (b){
var x__5393__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_51711(b);
}
});

var cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_51713 = (function (b,itm){
var x__5393__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_51713(b,itm);
}
});

var cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_51714 = (function (b){
var x__5393__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_51714(b);
}
});
