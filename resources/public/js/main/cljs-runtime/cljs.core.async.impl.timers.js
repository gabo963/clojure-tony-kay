...
var i_53855 = (0);
while(true){
if((i_53855 < arr.length)){
(arr[i_53855] = null);

var G__53856 = (i_53855 + (1));
i_53855 = G__53856;
continue;
} else {
}
...
var i_53866 = (self__.level + (1));
while(true){
if((i_53866 <= (new_level + (1)))){
(update[i_53866] = self__.header);

var G__53867 = (i_53866 + (1));
i_53866 = G__53867;
continue;
} else {
}
...
while(true){
if((i <= self__.level)){
var links_53869 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_53869[i]));
} else {
x__$2.forward.push((((i < links_53869.length))?(links_53869[i]):null));
}

if((i < links_53869.length)){
(links_53869[i] = x__$2);
} else {
links_53869.push(x__$2);
}
...
var i_53871 = (0);
while(true){
if((i_53871 <= self__.level)){
var links_53872 = (update[i_53871]).forward;
if((x__$1 === (((i_53871 < links_53872.length))?(links_53872[i_53871]):null))){
(links_53872[i_53871] = (x__$1.forward[i_53871]));

var G__53874 = (i_53871 + (1));
i_53871 = G__53874;
continue;
} else {
var G__53875 = (i_53871 + (1));
i_53871 = G__53875;
continue;
}
} else {
...
var G__53877 = nx;
var G__53878 = (level__$1 - (1));
x = G__53877;
level__$1 = G__53878;
continue;
} else {
var G__53879 = x;
var G__53880 = (level__$1 - (1));
x = G__53879;
level__$1 = G__53880;
continue;
}
...
if(cljs.core.truth_(nx)){
var G__53882 = nx;
var G__53883 = (level__$1 - (1));
x = G__53882;
level__$1 = G__53883;
continue;
} else {
var G__53884 = x;
var G__53885 = (level__$1 - (1));
x = G__53884;
level__$1 = G__53885;
continue;
}
