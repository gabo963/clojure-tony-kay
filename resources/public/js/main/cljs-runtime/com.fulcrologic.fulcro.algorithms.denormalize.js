 ...
 *   lookup refs.
 */
com.fulcrologic.fulcro.algorithms.denormalize.follow_ref = (function com$fulcrologic$fulcro$algorithms$denormalize$follow_ref(state_map,p__57741){
var vec__57742 = p__57741;
var table = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57742,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57742,(1),null);
var ref = vec__57742;
 ...
 */
com.fulcrologic.fulcro.algorithms.denormalize.ref_key = (function com$fulcrologic$fulcro$algorithms$denormalize$ref_key(p__57754){
var vec__57755 = p__57754;
var table = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57755,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57755,(1),null);
var ref = vec__57755;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Symbol(null,"_","_",-1201019570,null),id)){
return table;
} else {
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (n,p__57760){
var map__57761 = p__57760;
var map__57761__$1 = cljs.core.__destructure_map(map__57761);
var key = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57761__$1,new cljs.core.Keyword(null,"key","key",-1516042587));
...
com.fulcrologic.fulcro.algorithms.denormalize.add_join_BANG_ = (function com$fulcrologic$fulcro$algorithms$denormalize$add_join_BANG_(n,p__57763,entity,state_map,parent_node,idents_seen){
var map__57764 = p__57763;
var map__57764__$1 = cljs.core.__destructure_map(map__57764);
var join_node = map__57764__$1;
var query = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57764__$1,new cljs.core.Keyword(null,"query","query",-1288509510));
var key = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57764__$1,new cljs.core.Keyword(null,"key","key",-1516042587));
...
com.fulcrologic.fulcro.algorithms.denormalize.add_union_BANG_ = (function com$fulcrologic$fulcro$algorithms$denormalize$add_union_BANG_(n,p__57782,entity,state_map,idents_seen){
var map__57785 = p__57782;
var map__57785__$1 = cljs.core.__destructure_map(map__57785);
var join_node = map__57785__$1;
var key = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57785__$1,new cljs.core.Keyword(null,"key","key",-1516042587));
var link_join_QMARK_ = com.fulcrologic.fulcro.algorithms.denormalize.lookup_ref_QMARK_(key);
...
var union_key__GT_query = cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (result,p__57786){
var map__57787 = p__57786;
var map__57787__$1 = cljs.core.__destructure_map(map__57787);
var node = map__57787__$1;
var union_key = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57787__$1,new cljs.core.Keyword(null,"union-key","union-key",1529707234));
...
var vec__57792 = lookup_ref;
var table = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57792,(0),null);
...
if(cljs.core.truth_(temp__5802__auto__)){
var e = temp__5802__auto__;
var temp__5802__auto____$1 = (function (){var G__57796 = cljs.core.first(v);
return (union_key__GT_query.cljs$core$IFn$_invoke$arity$1 ? union_key__GT_query.cljs$core$IFn$_invoke$arity$1(G__57796) : union_key__GT_query.call(null,G__57796));
})();
if(cljs.core.truth_(temp__5802__auto____$1)){
var target_ast_node = temp__5802__auto____$1;
 ...
 */
com.fulcrologic.fulcro.algorithms.denormalize.denormalize = (function com$fulcrologic$fulcro$algorithms$denormalize$denormalize(p__57807,current_entity,state_map,idents_seen){
var map__57808 = p__57807;
var map__57808__$1 = cljs.core.__destructure_map(map__57808);
var top_node = map__57808__$1;
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57808__$1,new cljs.core.Keyword(null,"type","type",1174270348));
var children = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57808__$1,new cljs.core.Keyword(null,"children","children",-940561982));
...
if(cljs.core.truth_(and__5043__auto__)){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Symbol(null,"*","*",345799209,null),(function (){var G__57810 = nil_nodes;
var G__57810__$1 = (((G__57810 == null))?null:cljs.core.first(G__57810));
if((G__57810__$1 == null)){
return null;
} else {
return new cljs.core.Keyword(null,"key","key",-1516042587).cljs$core$IFn$_invoke$arity$1(G__57810__$1);
}
})());
} else {
return and__5043__auto__;
...
var G__57814 = result_node__$1;
var G__57814__$1 = (((G__57814 == null))?null:cljs.core.persistent_BANG_(G__57814));
if((G__57814__$1 == null)){
return null;
} else {
return com.fulcrologic.fulcro.algorithms.denormalize.with_time(G__57814__$1,com.fulcrologic.fulcro.algorithms.denormalize._STAR_denormalize_time_STAR_);
}
});
/**
...
var _STAR_denormalize_time_STAR__orig_val__57820 = com.fulcrologic.fulcro.algorithms.denormalize._STAR_denormalize_time_STAR_;
var _STAR_denormalize_time_STAR__temp_val__57821 = com.fulcrologic.fulcro.algorithms.denormalize.current_time();
(com.fulcrologic.fulcro.algorithms.denormalize._STAR_denormalize_time_STAR_ = _STAR_denormalize_time_STAR__temp_val__57821);

try{var ast = edn_query_language.core.query__GT_ast(query);
var G__57822 = com.fulcrologic.fulcro.algorithms.denormalize.denormalize(ast,starting_entity,state_map,cljs.core.PersistentArrayMap.EMPTY);
if((G__57822 == null)){
return null;
} else {
return com.fulcrologic.fulcro.algorithms.denormalize.with_time(G__57822,com.fulcrologic.fulcro.algorithms.denormalize._STAR_denormalize_time_STAR_);
}
}finally {(com.fulcrologic.fulcro.algorithms.denormalize._STAR_denormalize_time_STAR_ = _STAR_denormalize_time_STAR__orig_val__57820);
}});
/**
...
var G__57823 = props;
var G__57823__$1 = (((G__57823 == null))?null:cljs.core.meta(G__57823));
if((G__57823__$1 == null)){
return null;
} else {
return new cljs.core.Keyword("com.fulcrologic.fulcro.algorithms.denormalize","time","com.fulcrologic.fulcro.algorithms.denormalize/time",-375164969).cljs$core$IFn$_invoke$arity$1(G__57823__$1);
}
});
/**
...
var _STAR_root_keys_and_idents_STAR__orig_val__57827 = com.fulcrologic.fulcro.algorithms.denormalize._STAR_root_keys_and_idents_STAR_;
var _STAR_root_keys_and_idents_STAR__temp_val__57828 = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(cljs.core.transient$(cljs.core.PersistentHashSet.createAsIfByAssoc([root_key_or_ident])));
(com.fulcrologic.fulcro.algorithms.denormalize._STAR_root_keys_and_idents_STAR_ = _STAR_root_keys_and_idents_STAR__temp_val__57828);
...
}finally {(com.fulcrologic.fulcro.algorithms.denormalize._STAR_root_keys_and_idents_STAR_ = _STAR_root_keys_and_idents_STAR__orig_val__57827);
}});
/**
...
var map__57835 = cljs.core.meta(prior_props);
var map__57835__$1 = cljs.core.__destructure_map(map__57835);
var visited = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57835__$1,new cljs.core.Keyword("com.fulcrologic.fulcro.algorithms.denormalize","visited","com.fulcrologic.fulcro.algorithms.denormalize/visited",823384252));
var source_state_map = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57835__$1,new cljs.core.Keyword("com.fulcrologic.fulcro.algorithms.denormalize","source-state-map","com.fulcrologic.fulcro.algorithms.denormalize/source-state-map",-1097808870));
