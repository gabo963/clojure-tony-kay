...
var len__4730__auto___42273 = arguments.length;
var i__4731__auto___42274 = (0);
while(true){
if((i__4731__auto___42274 < len__4730__auto___42273)){
args__4736__auto__.push((arguments[i__4731__auto___42274]));

var G__42275 = (i__4731__auto___42274 + (1));
i__4731__auto___42274 = G__42275;
continue;
} else {
}
break;
...
/** @this {Function} */
devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq42194){
var G__42195 = cljs.core.first(seq42194);
var seq42194__$1 = cljs.core.next(seq42194);
var G__42196 = cljs.core.first(seq42194__$1);
var seq42194__$2 = cljs.core.next(seq42194__$1);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__42195,G__42196,seq42194__$2);
});
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__42209_SHARP_){
return (!((cljs.core.meta(p1__42209_SHARP_) == null)));
})))){
...
var map__42255 = opts;
var map__42255__$1 = (((((!((map__42255 == null))))?(((((map__42255.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__42255.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__42255):map__42255);
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42255__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e42259){var _e__41262__auto__ = e42259;
return false;
}})();
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
...
}catch (e42261){var _e__41262__auto__ = e42261;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__42263 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__42264 = devtools.formatters.state.get_current_state();
devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__42264;

try{var map__42265 = opts;
var map__42265__$1 = (((((!((map__42265 == null))))?(((((map__42265.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__42265.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__42265):map__42265);
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42265__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__42263;
}});
...
;
var temp__5802__auto___42313 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5802__auto___42313)){
var managed_print_level_42314 = temp__5802__auto___42313;
var _STAR_print_level_STAR__orig_val__42271_42315 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__42272_42316 = managed_print_level_42314;
cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__42272_42316;

try{devtools.formatters.state.update_current_state_BANG_(((function (_STAR_print_level_STAR__orig_val__42271_42315,_STAR_print_level_STAR__temp_val__42272_42316,managed_print_level_42314,temp__5802__auto___42313,writer,opts,job_fn){
return (function (p1__42270_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__42270_SHARP_,null);
});})(_STAR_print_level_STAR__orig_val__42271_42315,_STAR_print_level_STAR__temp_val__42272_42316,managed_print_level_42314,temp__5802__auto___42313,writer,opts,job_fn))
);

job_fn();
}finally {cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__42271_42315;
}} else {
job_fn();
}
