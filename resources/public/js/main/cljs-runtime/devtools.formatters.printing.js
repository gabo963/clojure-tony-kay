...
var G__42269 = (i__4731__auto___42266 + (1));
i__4731__auto___42266 = G__42269;
continue;
} else {
}
break;
...
/** @this {Function} */
devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq42178){
...
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__42179,G__42180,seq42178__$2);
});
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__42195_SHARP_){
return (!((cljs.core.meta(p1__42195_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42215__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e42223){var _e__41248__auto__ = e42223;
return false;
}})();
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
...
}catch (e42225){var _e__41248__auto__ = e42225;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__42237 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__42238 = devtools.formatters.state.get_current_state();
devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__42238;

try{var map__42239 = opts;
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42239__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__42237;
}});
...
;
var temp__5802__auto___42336 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5802__auto___42336)){
var managed_print_level_42337 = temp__5802__auto___42336;
var _STAR_print_level_STAR__orig_val__42248_42338 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__42249_42339 = managed_print_level_42337;
cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__42249_42339;

try{devtools.formatters.state.update_current_state_BANG_(((function (_STAR_print_level_STAR__orig_val__42248_42338,_STAR_print_level_STAR__temp_val__42249_42339,managed_print_level_42337,temp__5802__auto___42336,writer,opts,job_fn){
return (function (p1__42243_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__42243_SHARP_,null);
});})(_STAR_print_level_STAR__orig_val__42248_42338,_STAR_print_level_STAR__temp_val__42249_42339,managed_print_level_42337,temp__5802__auto___42336,writer,opts,job_fn))
);

job_fn();
}finally {cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__42248_42338;
}} else {
job_fn();
}
