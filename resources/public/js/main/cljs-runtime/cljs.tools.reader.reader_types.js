...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_50172 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_50172(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_50174 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_50174(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_50175 = (function (reader,ch){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_50175(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_50176 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_50176(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_50184 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_50184(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_50186 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_50186(reader);
}
});
...
var G__50236 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__50237 = s.append(c);
c = G__50236;
s = G__50237;
continue;
}
