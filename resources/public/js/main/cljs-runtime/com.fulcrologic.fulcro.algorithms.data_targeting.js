...
var len__5769__auto___58620 = arguments.length;
var i__5770__auto___58621 = (0);
while(true){
if((i__5770__auto___58621 < len__5769__auto___58620)){
args__5775__auto__.push((arguments[i__5770__auto___58621]));

var G__58622 = (i__5770__auto___58621 + (1));
i__5770__auto___58621 = G__58622;
continue;
} else {
}
break;
...
/** @this {Function} */
(com.fulcrologic.fulcro.algorithms.data_targeting.multiple_targets.cljs$lang$applyTo = (function (seq58509){
var self__5755__auto__ = this;
return self__5755__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq58509));
}));
...
var args__5775__auto__ = [];
var len__5769__auto___58634 = arguments.length;
var i__5770__auto___58635 = (0);
while(true){
if((i__5770__auto___58635 < len__5769__auto___58634)){
args__5775__auto__.push((arguments[i__5770__auto___58635]));

var G__58637 = (i__5770__auto___58635 + (1));
i__5770__auto___58635 = G__58637;
continue;
} else {
}
break;
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (state__$1,p__58548){
var vec__58549 = p__58548;
var command = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58549,(0),null);
var data_path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58549,(1),null);
var already_has_ident_at_path_QMARK_ = (function (data_path__$1){
return cljs.core.some((function (p1__58541_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(p1__58541_SHARP_,ident);
}),cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(state__$1,data_path__$1));
});
var G__58553 = command;
var G__58553__$1 = (((G__58553 instanceof cljs.core.Keyword))?G__58553.fqn:null);
switch (G__58553__$1) {
case "prepend":
if(cljs.core.truth_(already_has_ident_at_path_QMARK_(data_path))){
return state__$1;
} else {
return cljs.core.update_in.cljs$core$IFn$_invoke$arity$3(state__$1,data_path,(function (p1__58542_SHARP_){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [ident], null),p1__58542_SHARP_);
}));
}
...
/** @this {Function} */
(com.fulcrologic.fulcro.algorithms.data_targeting.integrate_ident_STAR_.cljs$lang$applyTo = (function (seq58544){
var G__58545 = cljs.core.first(seq58544);
var seq58544__$1 = cljs.core.next(seq58544);
var G__58546 = cljs.core.first(seq58544__$1);
var seq58544__$2 = cljs.core.next(seq58544__$1);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__58545,G__58546,seq58544__$2);
}));
...
if(com.fulcrologic.fulcro.algorithms.data_targeting.special_target_QMARK_(target__$1)){
var G__58604 = state_map__$1;
var G__58604__$1 = ((com.fulcrologic.fulcro.algorithms.data_targeting.prepend_target_QMARK_(target__$1))?com.fulcrologic.fulcro.algorithms.data_targeting.integrate_ident_STAR_.cljs$core$IFn$_invoke$arity$variadic(G__58604,item_to_place,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"prepend","prepend",342616040),target__$1], 0)):G__58604);
var G__58604__$2 = ((com.fulcrologic.fulcro.algorithms.data_targeting.append_target_QMARK_(target__$1))?com.fulcrologic.fulcro.algorithms.data_targeting.integrate_ident_STAR_.cljs$core$IFn$_invoke$arity$variadic(G__58604__$1,item_to_place,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"append","append",-291298229),target__$1], 0)):G__58604__$1);
if(com.fulcrologic.fulcro.algorithms.data_targeting.replacement_target_QMARK_(target__$1)){
return com.fulcrologic.fulcro.algorithms.data_targeting.integrate_ident_STAR_.cljs$core$IFn$_invoke$arity$variadic(G__58604__$2,item_to_place,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"replace","replace",-786587770),target__$1], 0));
} else {
return G__58604__$2;
}
} else {
...
var G__58607 = process_target_impl(state_map,source_path,target);
var G__58607__$1 = (cljs.core.truth_((function (){var and__5043__auto__ = remove_source_QMARK_;
if(cljs.core.truth_(and__5043__auto__)){
return (source_path instanceof cljs.core.Keyword);
} else {
return and__5043__auto__;
}
})())?cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(G__58607,source_path):G__58607);
...
return taoensso.encore.dissoc_in.cljs$core$IFn$_invoke$arity$2(G__58607__$1,source_path);
} else {
return G__58607__$1;
}
}));
