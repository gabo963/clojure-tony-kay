...
var o41678 = temp__5802__auto__;
var temp__5802__auto____$1 = (o41678["core"]);
if(cljs.core.truth_(temp__5802__auto____$1)){
var o41679 = temp__5802__auto____$1;
return (o41679["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__41222__auto__ = f;
return (o__41222__auto__["toString"]).call(o__41222__auto__);
} else {
return "";
}
}catch (e41687){var _ = e41687;
return "";
}});
...
try{var o__41222__auto___42047 = t;
(o__41222__auto___42047["cljs$lang$ctorPrWriter"]).call(o__41222__auto___42047,t,writer);
}catch (e41691){var __42048 = e41691;
}
...
var char_code = (function (){var o__41222__auto__ = (new String(char$));
return (o__41222__auto__["charCodeAt"]).call(o__41222__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__41222__auto__ = String;
return (o__41222__auto__["fromCharCode"]).call(o__41222__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__41697 = num_code;
switch (G__41697) {
case (1):
return (185);
...
var o__41222__auto__ = String;
return (o__41222__auto__["fromCharCode"]).call(o__41222__auto__,superscript_code);
});
/**
...
}catch (e41709){var _e__41248__auto__ = e41709;
return false;
}})())){
...
var vec__41710 = devtools.munging.parse_fn_source(fn_source);
var name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41710,(0),null);
...
if(cljs.core.truth_(temp__5802__auto__)){
var o41724 = temp__5802__auto__;
var temp__5802__auto____$1 = (o41724["dependencies_"]);
if(cljs.core.truth_(temp__5802__auto____$1)){
var o41725 = temp__5802__auto____$1;
return (o41725["nameToPath"]);
} else {
return null;
}
} else {
...
var G__42072 = (i__4731__auto___42071 + (1));
i__4731__auto___42071 = G__42072;
continue;
} else {
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__41732){
var vec__41748 = p__41732;
var ns_detector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41748,(0),null);
...
var G__42076 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last(remaining_tokens)], null),name_tokens);
var G__42077 = cljs.core.butlast(remaining_tokens);
name_tokens = G__42076;
remaining_tokens = G__42077;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq41729){
var G__41730 = cljs.core.first(seq41729);
var seq41729__$1 = cljs.core.next(seq41729);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__41730,seq41729__$1);
});
...
var vec__41762 = cljs.core.split_with((function (p1__41759_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__41759_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41762,(0),null);
var arity_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41762,(1),null);
...
var vec__41780 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(remaining_tokens,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([detector], 0));
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41780,(0),null);
var name_and_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41780,(1),null);
if(cljs.core.empty_QMARK_(protocol_ns)){
var G__42083 = cljs.core.rest(remaining_tokens);
var G__42084 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(name_tokens,cljs.core.first(remaining_tokens));
remaining_tokens = G__42083;
name_tokens = G__42084;
continue;
} else {
...
var vec__41804 = devtools.munging.strip_arity(tokens);
var tokens__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41804,(0),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41804,(1),null);
var vec__41807 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(tokens__$1,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([effective_detector], 0));
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41807,(0),null);
var tokens__$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41807,(1),null);
var vec__41810 = devtools.munging.parse_protocol(tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41810,(0),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41810,(1),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41810,(2),null);
var protocol_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41810,(3),null);
...
var vec__41823 = result;
var munged_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41823,(0),null);
var munged_name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41823,(1),null);
var munged_protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41823,(2),null);
var munged_protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41823,(3),null);
var munged_protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41823,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41823,(5),null);
...
if(cljs.core.truth_(temp__5802__auto__)){
var vec__41826 = temp__5802__auto__;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41826,(0),null);
var args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41826,(1),null);
var vec__41830 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$1(munged_name);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41830,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41830,(1),null);
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(cljs.core.take.cljs$core$IFn$_invoke$arity$2((2),fn_info),cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),(function (){var G__41836 = cljs.core.second(cljs.core.first(arities));
return (devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1 ? devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1(G__41836) : devtools.munging.parse_fn_info_deep.call(null,G__41836));
})()));
}
} else {
return fn_info;
...
var G__42115 = (arity + (1));
var G__42116 = (function (){var temp__5802__auto__ = devtools.munging.get_fn_fixed_arity(f,arity);
if(cljs.core.truth_(temp__5802__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__41887){
var vec__41888 = p__41887;
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41888,(0),null);
var arity_fn = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41888,(1),null);
...
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(arities,p1__41905_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return (function (p1__41906_SHARP_){
return cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),p1__41906_SHARP_);
...
var args__4736__auto__ = [];
var len__4730__auto___42167 = arguments.length;
var i__4731__auto___42168 = (0);
while(true){
if((i__4731__auto___42168 < len__4730__auto___42167)){
args__4736__auto__.push((arguments[i__4731__auto___42168]));

var G__42169 = (i__4731__auto___42168 + (1));
i__4731__auto___42168 = G__42169;
continue;
} else {
}
break;
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__41913){
var vec__41914 = p__41913;
var humanize_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41914,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq41907){
var G__41908 = cljs.core.first(seq41907);
var seq41907__$1 = cljs.core.next(seq41907);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__41908,seq41907__$1);
});
...
var include_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41946__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41946__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41946__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41946__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__41947 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$2(munged_name,ns_detector);
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41947,(0),null);
var fn_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41947,(1),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41947,(2),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41947,(3),null);
var protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41947,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41947,(5),null);
...
var o__41222__auto__ = f;
return (o__41222__auto__["getBasis"]).call(o__41222__auto__);
});
/**
...
}catch (e41968){var _e__41248__auto__ = e41968;
...
var G__42190 = (obj[cljs.core.first(path)]);
var G__42191 = cljs.core.rest(path);
obj = G__42190;
path = G__42191;
continue;
} else {
...
return (function (accum,p__42023){
var vec__42024 = p__42023;
var bit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42024,(0),null);
var protocol = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42024,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__42027){
var vec__42028 = p__42027;
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42028,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42028,(1),null);
var selector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42028,(2),null);
...
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42040,(0),null);
var matches__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42040,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2(((function (name,sorted_matches,vec__42040,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__42031_SHARP_){
return (obj[cljs.core.first(p1__42031_SHARP_)]);
});})(name,sorted_matches,vec__42040,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
